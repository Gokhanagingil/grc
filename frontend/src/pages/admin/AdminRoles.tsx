...
const ALL_PERMISSIONS: Permission[] = [
  ...
  { id: 'grc:audit:read', name: 'View Audits', description: 'View audits and audit details' },
  { id: 'grc:audit:write', name: 'Manage Audits', description: 'Create, update, and delete audits' },
  { id: 'grc:control:read', name: 'View Controls', description: 'View controls and control details' },
  { id: 'grc:control:write', name: 'Manage Controls', description: 'Create and update controls' },
  { id: 'grc:control:delete', name: 'Delete Controls', description: 'Delete controls' },
  { id: 'grc:process:read', name: 'View Processes', description: 'View processes, controls, results, and violations' },
  { id: 'grc:process:write', name: 'Manage Processes', description: 'Create and update processes, controls, and results' },
  { id: 'grc:process:delete', name: 'Delete Processes', description: 'Delete processes' },
  { id: 'grc:statistics:read', name: 'View Statistics', description: 'View statistics and analytics dashboards' },
  { id: 'grc:admin', name: 'GRC Admin Access', description: 'Full administrative access to all GRC features' },
  ...
  { id: 'admin:users:read', name: 'View Users', description: 'View users and user details' },
  { id: 'admin:users:write', name: 'Manage Users', description: 'Create, update, and delete users' },
  { id: 'admin:roles:read', name: 'View Roles', description: 'View roles and role permissions' },
  { id: 'admin:roles:write', name: 'Manage Roles', description: 'Create, update, and delete roles' },
  { id: 'admin:settings:read', name: 'View Settings', description: 'View system settings' },
  { id: 'admin:settings:write', name: 'Manage Settings', description: 'Modify system settings' },
  { id: 'admin:tenants:read', name: 'View Tenants', description: 'View tenants and tenant details' },
  { id: 'admin:tenants:write', name: 'Manage Tenants', description: 'Create, update, and delete tenants' },
];
