...
DELETE FROM cmdb_ci_rels WHERE tenant_id = '00000000-0000-0000-0000-000000000001' AND source_ci_id LIKE 'dddd02%';
DELETE FROM cmdb_cis WHERE tenant_id = '00000000-0000-0000-0000-000000000001' AND id LIKE 'dddd02%';
